...
<table class="easyui-datagrid" id="itemList" title="商品列表"
	data-options="singleSelect:false,collapsible:true,pagination:true,url:'/kenya/news/pageQuery',method:'get',pageSize:10, pageNumber:4,pageList: [5,10,15,20],toolbar:toolbar" >
	<thead>
		<tr>
